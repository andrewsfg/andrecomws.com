...
function custom_post_example() { 
	...
	register_post_type( 'slider', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			'name' => __('Slider', 'post type general name'), /* This is the Title of the Group */
	...
	register_post_type( 'portfolio', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			...
			'singular_name' => __('Custom Post', 'post type singular name'), /* This is the individual type */
			'add_new' => __('Adicionar novo', 'custom post type item'), /* The add new menu item */
			'add_new_item' => __('Add New Custom Type'), /* Add New Display Title */
			'edit' => __( 'Edit' ), /* Edit Dialog */
			'edit_item' => __('Editar Post Types'), /* Edit Display Title */
			'new_item' => __('New Post Type'), /* New Display Title */
			'view_item' => __('View Post Type'), /* View Display Title */
			'search_items' => __('Search Post Type'), /* Search Custom Type Title */ 
			'not_found' =>  __('Nothing found in the Database.'), /* This displays if there are no entries yet */ 
	...
	*/
    ...
    register_taxonomy( 'trabalhos', 
    	array('portfolio'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
    	array('hierarchical' => true,     /* if this is true it acts like categories  */             
    		'labels' => array(
    			'name' => __( 'Trabalhos' ), /* name of the custom taxonomy */
    			'singular_name' => __( 'Trabalhos' ), /* single taxonomy name */
    			'search_items' =>  __( 'Trabalhos' ), /* search title for taxomony */
    			'all_items' => __( 'Todos trabalhos' ), /* all title for taxonomies */
