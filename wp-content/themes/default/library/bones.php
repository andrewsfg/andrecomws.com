...
function bones_excerpt_more($more) {
	...
	return '...  <a href="'. get_permalink($post->ID) . '" title="Leia - '.get_the_title($post->ID).'">Leia mais &raquo;</a>';
}
...
function page_navi($before = '', $after = '') {
	...
	echo $before.'<nav role="navigation" class="page-navigation"><ol class="bones_page_navi clearfix">'."";
	if ($start_page >= 2 && $pages_to_show < $max_page) {
		$first_page_text = "Primeiro";
