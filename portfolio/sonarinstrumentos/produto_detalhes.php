...
while($r_prod = mysql_fetch_array($q_sel_prod)){
 ...
 align="left" hspace="5" vspace="0" border="0" alt="'.$nome.'" title="'.$nome.'" /></div>';
	...
	print "<strong>Descrição Curta: </strong>".$desc_longa."<br /><br />";

	print "<strong><h3>Preço: </strong><span class='preco2'>R$".$preco."</span></h3><br /><br /><br /><br />";
