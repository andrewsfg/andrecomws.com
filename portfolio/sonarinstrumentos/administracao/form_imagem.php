...
<body><form action="sql_ins_imagem.php" method="post" enctype="multipart/form-data" name="ins_imagem" id="ins_imagem">
...
<table width="500" border="1">
  ...
  <tr>
    ...
    <td><input name="ins_imagem" type="submit" id="ins_imagem" value="Enviar imagens" /></td>
