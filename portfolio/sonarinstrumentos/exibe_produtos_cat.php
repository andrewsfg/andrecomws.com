...
<div id="container">
    ...
    <div id="menu_vertical"><?php include("inc/menu_vertical_cat.php");//MENU DA CATEGORIA CLICADA?></div>

    

    

    <div id="conteudo"><h3>PRODUTOS:</h3><?php include("inc/produtos_subcat.php");//PRODUTOS SUBCATEGORIA CLICADA?></div>
