...
$sel_subcategoria = "SELECT nome FROM subcategoria WHERE id_subcat = '$subcat'";
...
$sel_prod = "SELECT id_produto,nome,desc_curta,preco FROM produtos 
			...
			WHERE categoria_id = '$idcat' AND subcat_id = '$subcat'";
...
while($r_prod = mysql_fetch_array($q_sel_prod)){
	...
	print "<strong>Apenas: </strong><span class='preco'>R$".$preco."</a></span></div>";
